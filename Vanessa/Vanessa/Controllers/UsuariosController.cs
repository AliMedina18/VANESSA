...
namespace Vanessa.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Index(string search = "", int page = 1)
        {
            ...
            // Filtrar usuarios si se proporciona un término de búsqueda
            ...
            ViewBag.Search = search; // Pasar el valor del buscador a la vista
        ...
        public async Task<IActionResult> Inactivos(string search = "")
        {
            ...
            ViewBag.Search = search; // Para mantener el término en la vista
        ...
        public async Task<IActionResult> CreateOrEdit(int? id)
        {
            ...
            if (id.HasValue)
            {
                usuario = await _context.Usuarios.FindAsync(id) ?? new Usuario(); // Si no encuentra, inicializa uno nuevo
            }
            else
            {
                usuario = new Usuario(); // Si no se pasa un ID, se trata de una creación, por lo que inicializamos un nuevo usuario
            }
