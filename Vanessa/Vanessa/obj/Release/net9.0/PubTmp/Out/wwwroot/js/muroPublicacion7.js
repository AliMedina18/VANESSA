...
const abrirEditar = document.getElementById("editarPublic");
const crearPu = document.getElementById("crearPu");
const tE = document.getElementById("tituloE");
const tC = document.getElementById("tituloC");
...
function mostrarFormEditar(){
    ...
    abrirEditar.classList.remove("hide");
    crearPu.classList.add("hide");
